-- Update SEP Point System Members
-- Run this in your Supabase SQL Editor to update the member list

-- First, let's clear existing members (optional - comment out if you want to keep existing data)
-- TRUNCATE TABLE members CASCADE;

-- Delete all existing members to start fresh
DELETE FROM members;

-- Insert all active members (starting with 100 points each)
